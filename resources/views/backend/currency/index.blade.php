            ...
            <form action="{{ route('currency.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="exchange_rate" required class="form-control" id="add_exchange_rate" min="1" placeholder="{{ __('db.Type exchange rate') }}">
                    </div>
            ...
            <form action="{{ route('currency.update', 1) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="exchange_rate" required class="form-control" id="edit_exchange_rate" min="1" placeholder="{{ __('db.Type exchange rate') }}">
                    </div>
